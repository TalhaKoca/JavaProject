...
<a href="https://github.com/TalhaKoca/JavaProject/tree/master/hrms/src"> <img width="18" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Octicons-mark-github.svg/900px-Octicons-mark-github.svg.png" data-canonical-src="https://r.resimlink.com/QKL2.png" style="max-width:100%;"> Main Directory </a>

![image](https://www.china-briefing.com/news/wp-content/uploads/2021/02/Right-to-Privacy-in-China%E2%80%99s-Civil-Code-and-its-Impact-on-HR-Management.jpg)

Spring - JavaSE-16.0.1 (jre) based.

Dependencies (Spring initializer)

:zap:	- Spring Boot DevTools
:zap:	Spring Web
:zap:	 Spring Data JPA
:zap:	 PostgreSQL Driver
:zap:	 Lombok
...
![image](https://github.com/TalhaKoca/JavaProject/blob/master/Ekran%20Al%C4%B1nt%C4%B1s%C4%B1.PNG?raw=true)
